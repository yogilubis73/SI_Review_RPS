...
<center><h3><b> <img src="img/rps.png" style="width:25px; height:25px;">Edit File</b></h3></center>
...
<button type='button' class='btn btn-success center-block' style="margin-bottom:20px;">Update</button>
